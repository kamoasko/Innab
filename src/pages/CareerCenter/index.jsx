      ...
      <section className={styles.career}>
        <div className="container">
          ...
          >
            ...
            <div className={`${styles.careerDetails} flex flexDirectionColumn`}>
              <div>
                <img src={career} alt="" />
              </div>
              ...
              <p>
                ...
                yaratmaqla kifayətlənməmiş və məzunlarımızın uğurlu karyerasına
                öz töhfəsini verməkdə davam edir. INNAB Karyera Mərkəzi “Məzun
                layihəsi” çərçivəsində INNAB Business School-un təlimlərində
                iştirak edərək, fərqlənmə sertifikatı ilə bitirən məzunlarımızın
                işlə təmin olunmasında öz köməyini əsirgəmir. “İnnab Karyera
                Mərkəzi”nin əməkdaşlıq etdiyi dövlət və özəl qurumlarda olan
                vakansiyalara yuxarıda qeyd edilən kriteriyalara uyğun
                məzunların cvləri yönləndirilir. Məhz bunun sayəsindədir ki, bu
                günədək 200-dən çox tələbəmizin işlə təmin edilməsində bizimdə
                payımız olmuşdur.
              </p>
            </div>
          </div>
          ...
          <div className={styles.careerRequirements}>
            ...
            <ul className="flex flexDirectionColumn">
              ...
              <li className="flex alignItemsCenter">
                ...
                <span>
                  DMA-da işsiz kimi qeydiyyatda olmalı (qeydiyyatda deyilsinizsə
                  biz tərəfdən köməklik ediləcəkdir);
                </span>
              </li>
            </ul>
          </div>
