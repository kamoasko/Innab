...
const videoLessons = [
  { title: "Excel haqqında ilkin anlayışlar", duration: "3:31" },
  {
    title: "Excel-də Copy, Paste, Cut, Format Painter əməliyyatları",
    duration: "9:05",
  },
  { title: "Excel haqqında ilkin anlayışlar", duration: "3:31" },
  { title: "Excel haqqında ilkin anlayışlar", duration: "3:31" },
            ...
            <div className={styles.detailMain}>
              <div className={`${styles.detailMainTop} flex`}>
                ...
                <div className={styles.detailTopics}>
                  <div className={`${styles.detailTopic} detailTopic active`}>
                    <div className="flex alignItemsCenter justifyContentBetween">
                      <h3>
                        Dərs 1: Excel, Paste Special: Values, Formulas, Formats,
                        Comments
                      </h3>
                      <FaChevronDown />
                    </div>
                    <ul className="flex flexDirectionColumn">
                      {videoLessons.map((lesson, index) => (
                        <li className="flex flexDirectionColumn" key={index}>
                          <span>
