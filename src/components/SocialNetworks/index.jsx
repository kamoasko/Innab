...
const SocialNetworks = React.memo(({ gap, contact }) => {
  ...
  return (
    <ul className="socialNetworks flex alignItemsCenter" style={{ gap: gap }}>
      <li>
        <Link to={infos && infos[0]?.facebook_link} target="_blank">
          <svg
      ...
      <li>
        <Link to={infos && infos[0]?.linkedin_link} target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
      ...
      <li>
        <Link to={infos && infos[0]?.tiktok_link} target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
      ...
      <li>
        <Link to={infos && infos[0]?.youtube_link} target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
