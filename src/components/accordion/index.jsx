    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div className={`${styles.accordionTitle} flex alignItemsCenter`}>
              <strong>01</strong> <h2>UI/UX dizayner</h2>
            </div>
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
          ...
          >
            <div className={`${styles.description} flex flexDirectionColumn`}>
              <strong>İşin təsviri</strong>
              <p>
                UI/UX dizaynerinin öhdəliklərinə istifadəçi tələblərinin
                toplanması, qrafik elementlərin dizaynı və naviqasiya
                komponentlərinin yaradılması daxildir.
              </p>
            </div>
            <div
            ...
            >
              <div>
                <strong>Öhdəlikləri və vəzifələri</strong>
                <ol className="flex flexDirectionColumn">
                  <li>
                    mobil tətbiqlər üçün istifadəçi interfeyslərini və
                    təcrübələrini dizayn edin və inkişaf etdirin
                  </li>
                  <li>
                    mobil tətbiqlər üçün istifadəçi interfeyslərini və
                    təcrübələrini dizayn edin və inkişaf etdirin
        ...
        <AccordionActions sx={{ marginTop: "5.2rem" }}>
          ...
          >
            <div>
              <strong>Qeyd:</strong> Cv-lərinizi bu{" "}
              <Link to={"mailto:info@innab.org"}>info@innab.org</Link> e-mailə
              göndərməyiniz xaiş olunur
            </div>
            <Button
              title={[
                <svg
